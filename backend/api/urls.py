...
urlpatterns = [
    ...
    path("<int:id>", views.account_view, name="account_view"),
    path("<int:id>/edit", views.edit_account_view, name="edit_account_view"),
    path("assignments", views.show_assignments_view, name="assignments"),
