...
def assignment_detail_view(request, id):
    """
    Get detailed information for a single assignment.
    ...
    if request.method == "GET":
        ...
        try:
            ...
            # Check permission (only the teacher who created it can view details)
            ...
            # Build unified assignment response
            assignment_detail = {
                "id": assignment.id,
            ...
            return JsonResponse(
                {"successful": True, "assignment": assignment_detail},
                status=200
            )
